  ...
  describe ProjectsController do
    ...
    context '#new' do
      it 'renders new template' do
        sign_in admin
        get :new, company_id: admin.company.id
    ...
    context '#create' do
      ...
      it 'will not Create new project if user id is repeated in project member for project' do
        ...
        post :create, project: {name: "project_new", "status"=>"pending", start_date: "08-04-2014", project_members_attributes: {"0"=> {user_id: admin.id, is_manager: "true", _destroy: "false"}, "0"=> {user_id: admin.id, is_manager: "false", _destroy: false}}, contact_persons_attributes: {"0"=> {name: "person", primary_email_id: "person@domain.com", secondary_email_id: "person1@domain.com", phone_no: "+91 1234567890", address: "pune", skype_id: "skype", linkedin_id: "link", twitter_id: "twit", _destroy: "false"}}}, company_id: admin.company
